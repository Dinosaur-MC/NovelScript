...
| `heading`            | `Heading`     | 是   | 结构化场标对象，详见 §4.5.2。                                |
...
| `source_ref`  | `SourceRef` | 是   | 溯源锚点，详见 §5。                                       |
